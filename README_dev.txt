...
cd /home/user/eclipse-workspace/BigsCoin
cd src
make -f makefile.unix
chmod -R 777 /home/user/eclipse-workspace/BigsCoin/src


touch .BigsCoin/BigsCoin.conf
vim .BigsCoin/BigsCoin.conf
added rpcuser & rpcpassword
start wallet
 ./BigsCoind --daemon -txindex
// check processing
 pidof BigsCoind
//

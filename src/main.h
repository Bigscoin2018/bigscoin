...
static const int LAST_POW_BLOCK = 262800; //POW block reward:  30 BGC

static const unsigned int MAX_BLOCK_SIZE = 3000000; //3MB
...
static const int64_t MAX_MONEY = 26000000 * COIN; //Maximum coin supply:  26.000.000
...
static const int64_t MAX_MINT_PROOF_OF_STAKE_V2 = 0.10 * COIN;	// 10% annual interest change at block 300000
...
static const uint256 hashGenesisBlock("0x0000aeee7241f333baeec20b1e3d79ef6d875c1e0332dcf7bf295ccbf010fd28");
static const uint256 hashGenesisBlockTestNet("");
inline int64_t PastDrift(int64_t nTime)   { return nTime - 10 * 60 * 60; } // up to 10 hours from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 10 * 60 * 60; } // up to 10 hours from the future
